...
`SCUMMVM.png` is from the libretro Systematic asset pack:
...
`SCUMMVM-photo.png` is an AI-generated render (OpenAI ChatGPT), cleaned to a
transparent square canvas and downscaled to 384x384 for the launcher. The
1254x1254 master is kept in the private `umrk-assets` repository at
`Systems/ICONS/SCUMMVM.png`. Purely AI-generated images carry no copyright of
their own, and no rights are claimed in the render itself.

Computer and software trade dress remains the property of the respective
rights holders and appears here to identify the platform.
