# SCUMMVM wordmark provenance

Runtime PNG: `SCUMMVM-wordmark.png`.

Vendored from private `umrk-assets`, commit `6a4f65d902a4f18c3e1d2394135dc7f61d329a0c`,
`Systems/WORDMARKS/exports/SCUMMVM.png`.
PNG SHA-256: `44586a9cd42ec160a421276167396ce019d9a358bc564d2f89bfae2becc711b4`.
Editable SVG SHA-256: `e0db4e847ca92c96a9d9da0198a11d04c9beb9a7dbe7fcea5a884f3652006d03`.

This white RGBA export has a maximum edge of 1024 pixels. Jawaka tints it to
...
removes color and extrusion, preserves the overlap between m and V and the VM
surface lines, and tightens the canvas. This derivative is also CC BY-SA 3.0.

No image model was used. No generation prompt applies.
